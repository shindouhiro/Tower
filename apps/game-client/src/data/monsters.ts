...
export const MONSTER_STAGES: MonsterStageConfig[] = [
  {
    ...
    name: '史莱姆',
    zoneName: '幽暗森林',
    image: '/assets/monster-stage1.png',
    bgImage: '/assets/background-scene.webp',
    themeHue: 0,
  ...
  },
  {
    ...
    name: '骷髅兵',
    zoneName: '暗影洞穴',
    image: '/assets/monster-stage2.png',
    bgImage: '/assets/bg-stage2.png',
    themeHue: 270,
  ...
  },
  {
    ...
    name: '火焰元素',
    zoneName: '熔岩火山',
    image: '/assets/monster-stage3.png',
    bgImage: '/assets/bg-stage3.png',
    themeHue: 15,
  ...
  },
  {
    ...
    name: '冰霜巨人',
    zoneName: '极寒冰原',
    image: '/assets/monster-stage4.png',
    bgImage: '/assets/bg-stage4.png',
    themeHue: 200,
  ...
  },
  {
    ...
    name: '深渊恶魔',
    zoneName: '无尽深渊',
    image: '/assets/monster-stage5.png',
    bgImage: '/assets/bg-stage5.png',
    themeHue: 340,
